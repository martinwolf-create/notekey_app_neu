...
class _FindEditScreenState extends State<FindEditScreen> {
  ...
  void initState() {
    ...
    if (it != null) {
      ...
      if (it.priceCents != null) {
        _priceCtl.text = (it.priceCents! / 100).toStringAsFixed(2);
      }
    }
  }
  ...
  Future<void> _save() async {
    ...
    if (t.isNotEmpty) {
      ...
      if (v != null) priceCents = (v * 100).round();
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const BasicTopBar(
          title: 'Find – Eintrag', showBack: true, showMenu: false),
            ...
            children: [
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'Währung', border: OutlineInputBorder()),
                ),
              ),
            ],
          ),
